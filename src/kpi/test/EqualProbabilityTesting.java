...
public class EqualProbabilityTesting {

    public static void main(String[] args) {
        EqualProbability epTest = new EqualProbability();
        epTest.setGenerateBytes(1000000);
        System.out.println("Test: " + EqualProbability.class.getSimpleName());
        System.out.println("Bytes: " + epTest.getGenerateBytes() + "\n");
