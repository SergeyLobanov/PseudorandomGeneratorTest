...
public class CharIndependenceTesting {
    ...
    public static void main(String[] args) {
        ...
        CharIndependence.test(bbs.generateMBytes(100));

        BBSbytes bbSbytes = new BBSbytes(p, q);
        bbs.setR(new BigInteger("17"));
        CharIndependence.test(bbSbytes.generateMBytes(100));
        ...
        CharIndependence.test(blumMicali.generateMBytes(100));

        BlumMicaliBytes blumMicaliBytes = new BlumMicaliBytes(A, P);
        CharIndependence.test(blumMicaliBytes.generateMBytes(100));
    }
