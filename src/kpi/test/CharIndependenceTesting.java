...
/*
        ...
        Homogeneity.test(bbs.generateMBytes(10000000));

        BBSbytes bbSbytes = new BBSbytes(p, q);
        bbs.setR(new BigInteger("17"));
        Homogeneity.test(bbSbytes.generateMBytes(10000000));
*/
...
//        Homogeneity.test(blumMicali.generateMBytes(1000000));

        BlumMicaliBytes blumMicaliBytes = new BlumMicaliBytes(A, P);
        Homogeneity.test(blumMicaliBytes.generateMBytes(1000000));
