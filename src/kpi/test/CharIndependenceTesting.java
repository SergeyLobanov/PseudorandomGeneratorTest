...
public class CharIndependenceTesting {
    ...
    public static void main(String[] args) {
        CharIndependence ciTest = new CharIndependence();
        ciTest.setGenerateBytes(1000000);
        System.out.println("Test: " + CharIndependence.class.getSimpleName());
        System.out.println("Bytes: " + ciTest.getGenerateBytes() + "\n");
